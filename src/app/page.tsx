...
function DemoPhone() {
  return (
    <div className="relative mx-auto w-[320px] rounded-[36px] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.05),rgba(255,255,255,0)),#0f1525] p-3 shadow-[0_30px_90px_-35px_rgba(47,100,255,0.75)]">
      <div className="rounded-[28px] border border-white/8 bg-[#0a0e1a] p-5">
...
export default async function RootPage() {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-[#0a0e1a] text-[var(--text-primary)]">
      <div className="pointer-events-none fixed inset-0 opacity-[0.04]" style={{ backgroundImage: "linear-gradient(rgba(120,145,220,.08) 1px, transparent 1px), linear-gradient(90deg, rgba(120,145,220,.08) 1px, transparent 1px)", backgroundSize: "72px 72px" }} />
      <div className="pointer-events-none fixed left-[-10%] top-[-5%] h-[34rem] w-[34rem] rounded-full bg-[radial-gradient(circle,rgba(47,100,255,0.32)_0%,transparent_65%)] blur-3xl" />
      <div className="pointer-events-none fixed bottom-[-8%] right-[-10%] h-[32rem] w-[32rem] rounded-full bg-[radial-gradient(circle,rgba(44,182,255,0.18)_0%,transparent_65%)] blur-3xl" />

      <header className="sticky top-0 z-40 border-b border-white/6 bg-[rgba(10,14,26,0.72)] backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 md:px-8">
          <div className="flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[linear-gradient(135deg,#6f9bff_0%,#2f64ff_60%,#1b3fb8_100%)] shadow-[0_10px_30px_-12px_rgba(47,100,255,0.9)]">
              <Brain className="h-5 w-5 text-white" />
            </div>
            <div>
              <div className="text-sm font-semibold text-white">LiveImproved</div>
          ...
          <div className="flex items-center gap-3">
            {isAuthenticated ? (
              <Link
                href="/dashboard"
                className="inline-flex items-center gap-2 rounded-full bg-[linear-gradient(135deg,#4f72ff_0%,#2cb6ff_100%)] px-4 py-2.5 text-sm font-semibold text-white shadow-[0_12px_40px_-18px_rgba(47,100,255,0.9)]"
              >
                Open dashboard
      ...
      <main>
        <section className="relative px-4 pb-20 pt-16 md:px-8 md:pb-28 md:pt-24">
          <div className="mx-auto grid max-w-7xl items-center gap-16 lg:grid-cols-[1.05fr_0.95fr]">
            <div>
              <h1 className="mt-6 text-5xl leading-[0.95] tracking-[-0.05em] text-white md:text-7xl" style={{ fontFamily: "var(--font-instrument-serif), Georgia, serif" }}>
                Track what makes
                <br />
                you better.
              </h1>
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                {isAuthenticated ? (
                  <Link
                    href="/dashboard"
                    className="inline-flex items-center gap-2 rounded-full bg-[linear-gradient(135deg,#4f72ff_0%,#2cb6ff_100%)] px-6 py-3.5 text-sm font-semibold text-white shadow-[0_18px_50px_-20px_rgba(47,100,255,0.9)]"
                  >
                    Open the app
                    <ArrowRight className="h-4 w-4" />
                  </Link>
            ...
            <div className="relative">
              <div className="absolute inset-x-8 bottom-[-2rem] h-32 rounded-full bg-[radial-gradient(circle,rgba(47,100,255,0.4)_0%,transparent_70%)] blur-3xl" />
              <DemoPhone />
            </div>
          </div>
        </section>
        ...
        <section id="how" className="px-4 py-20 md:px-8">
          <div className="mx-auto max-w-7xl">
            <div className="text-center">
              ...
              <h2 className="mt-4 text-4xl tracking-[-0.04em] text-white md:text-6xl" style={{ fontFamily: "var(--font-instrument-serif), Georgia, serif" }}>
                Your whole day,
            ...
            <div className="mt-14 grid gap-6 lg:grid-cols-4">
              {[
                ...
                <div key={step.step} className="rounded-[28px] border border-white/8 bg-[linear-gradient(180deg,rgba(255,255,255,0.03),rgba(255,255,255,0)),#0f1525] p-6">
                  <div className="text-xs font-semibold uppercase tracking-[0.22em] text-[var(--text-muted)]">
                    {step.step}
                  </div>
                  <h3 className="mt-4 text-2xl text-white" style={{ fontFamily: "var(--font-instrument-serif), Georgia, serif" }}>
                    {step.title}
                  </h3>
        ...
        <section id="score" className="px-4 py-20 md:px-8">
          <div className="mx-auto max-w-6xl rounded-[36px] border border-white/8 bg-[linear-gradient(180deg,rgba(255,255,255,0.03),rgba(255,255,255,0)),#0f1525] px-6 py-12 md:px-12">
            <div className="text-center">
              <div className="text-xs font-semibold uppercase tracking-[0.24em] text-[var(--text-muted)]">
                The score
              </div>
            ...
            <div className="mt-12 grid items-center gap-10 lg:grid-cols-[320px_1fr]">
              <div className="mx-auto flex h-72 w-72 items-center justify-center rounded-full border border-[#4f72ff]/20 bg-[radial-gradient(circle,rgba(79,127,255,0.14)_0%,rgba(15,21,37,0)_70%)]">
                <div className="flex h-56 w-56 flex-col items-center justify-center rounded-full border border-white/8 bg-[#0a0e1a]">
              ...
              <div className="grid gap-4">
                {laneCards.map((lane) => (
                  <div key={lane.name} className="rounded-2xl border border-white/8 bg-white/[0.03] p-4">
                    ...
                    <div className="h-2 overflow-hidden rounded-full bg-white/6">
                      <div className="h-full rounded-full" style={{ width: `${lane.score}%`, background: lane.color }} />
                    </div>
                  </div>
                ))}
              </div>
        ...
        <section className="px-4 pb-24 pt-8 md:px-8">
          <div className="mx-auto max-w-5xl text-center">
            <h2 className="text-4xl tracking-[-0.04em] text-white md:text-6xl" style={{ fontFamily: "var(--font-instrument-serif), Georgia, serif" }}>
              Stop estimating.
